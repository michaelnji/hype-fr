<script>
  ...
  let configClass = config ? config : "h-4 w-4 sm:h-6 sm:w-6";
</script>
...
{:else if name == "twitter"}
  <svg
    xmlns="http://www.w3.org/2000/svg"
    class={configClass + " fill-current"}
    viewBox="0 0 24 24"
    ><path
