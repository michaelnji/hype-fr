<script>
  ...
  import heroImg from "../../../Assets/Images/Smash Illustrations/New app.svg";
      ...
      <div class="hero min-h-screen">
        ...
        >
          ...
          <div class="font-sans lg:max-w-1/2 w-full">
            ...
            >
              Coming <span class="text-success"> Soon.... </span>
            </h1>
            <p class="py-6 lg:text-2xl text-xl text-center lg:text-left">
              Subscribe to plans and use our services for free for a limited
              amount of time. Cancel at any time and enjoy random giveaways.
            </p>
            <p class="py-6 lg:text-2xl text-xl text-center lg:text-left">
            ...
            <button
              disabled
              class="btn sm:btn-lg lg:btn-wide btn-success font-bold shadow-md btn-disabled  mx-auto lg:mx-0 w-full"
              >Get Started</button
            >
          </div>
        </div>
